...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./datasets/SR_datasets/celeba_crop_train',
                            help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='UFSRNet_sy92',
        ...
        parser.add_argument('--model', type=str, default='ufsrnet',
        ...
        parser.add_argument('--bottleneck_size', type=int, default=4,
                            help='bottleneck feature size in hourglass block')
